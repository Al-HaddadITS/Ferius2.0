<template>
    <div>
        ...
        <v-container v-for="(setting, i) in settings" v-bind:key="i">
                <v-layout row wrap>
                    <v-flex md3>
                                  <v-avatar
                          tile
                         ...
                         <img v-else :src="defaultAvatar" alt="ProfilePicture">
                          </v-avatar>
                    </v-flex>
                    <v-flex md9>
            ...
            <v-layout row wrap>
                <v-flex>
                  ...
                  <v-layout row wrap>
                      <v-spacer></v-spacer>
                      <v-flex xs2>
                        <v-btn raised :color="setting.app_color_secondary" dark @click="viewContract()">View Contract</v-btn>
                      </v-flex>
                  </v-layout>
