    ...
    <v-btn
      ...
      >
        <v-list class="pa-0 transparent">
          <v-list-tile avatar>
            <v-list-tile-avatar>
              <!-- <img src="https://randomuser.me/api/portraits/lego/5.jpg" v-if="admin"> -->
              <!-- v-else -->
              <v-avatar
              size="48"
              class="profilePic"
                          >
                         <img v-if="admin" :src="defaultAvatar" alt="ProfilePicture" style="height: 48px">
                         <img v-else-if="viewEmployee.profilePic" :src="viewEmployee.profilePic" alt="ProfilePicture" style="height: 48px">
                         <img v-else :src="defaultAvatar" alt="ProfilePicture" style="height: 48px">
                          </v-avatar>
            </v-list-tile-avatar>
      ...
      news: [
        ...
        watch: {
            user: function(val){
                ...
                this.$store.dispatch('viewEmployee', this.user.employee_id)
            },
            viewEmployee: function(val){
                // console.log(val)
            }
        },
        methods:{
